...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    <td height="24" align="center" nowrap  bgcolor="#EBF2F9"><b><a href="user_add1.asp?Result=Add" onClick='changeAdminFlag("添加管理员")'>
	<font color="#008000">添加管理员</font></a></b><font color="#0000FF">&nbsp;|&nbsp;</font><a href="user_list1.asp" onClick='changeAdminFlag("系统管理员")'><font color="#008000">查看所有管理员</font></a><a href="user_serch.asp" onclick='changeAdminFlag(&quot;系统管理员&quot;)'></a></td>    
  </tr>
</table>
  <center>
    <br/>
	...
	%>
	<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <form name="editForm" method="post" action="user_add1.asp?Action=addnew" onsubmit="return ybx_add()">
  <tr>
    <td height="24" nowrap bgcolor="#EBF2F9"><table width="100%" border="0" cellpadding="0" cellspacing="0" id=editProduct idth="100%">
      ...
      <tr>
        <td height="20" align="right"><b><font color="#0000FF">登录用户名：<br><br></font></b></td>
        <td><div align="left">
          <input name="user_no" type="text" class="textfield" id="user_no" style="WIDTH: 120;" size="15">
          &nbsp;*<br>(不能重复，提交后不能修改)</div></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="20" align="right"><b><font color="#0000FF">请输入密码：<br><br></font></b></td>
        <td><div align="left">
            <input name="user_pass" type="text" class="textfield" id="user_pass" style="WIDTH: 120;" value="admin" size="20" />
          	&nbsp;*<font color="#FF0000"> <br>(默认密码:admin)</font></div></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="30" align="right">　</td>
        <td valign="bottom"><div align="left">
        <input type="button" class="button" onclick="location.href='bnuzitc1.asp'" value=" 返 回 " style="WIDTH: 60; margin-left: 40px; ">
        </div></td>
        </tr>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <form name="editForm" method="post" action="user_add1.asp?Action=SaveEdit&ID=<%=request("ID")%>"  onsubmit="return ybx_add()">
  <tr>
    <td height="24" nowrap bgcolor="#EBF2F9"><table width="100%" border="0" cellpadding="0" cellspacing="0" id=editProduct idth="100%">
	...
	if Action = "addnew" then
		...
		rs.open sql1,conn,1,3
			if rs.bof and rs.eof then
				...
				rs.close
				set rs = nothing
				response.Redirect("user_list1.asp")
			else
