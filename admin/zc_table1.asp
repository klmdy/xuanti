...
<script language=JavaScript>
	function DoEmpty(ID)
	{
		...
		window.location = "zc_add1.asp?Action=del&ID="+ID ;
	}
</script>
<body>
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    <td height="24" align="center" nowrap  bgcolor="#EBF2F9"><a href="zc_add1.asp?Result=Add">添加教师职称</a><font color="#0000FF">&nbsp;|&nbsp;</font><a href="zc_table1.asp" onClick='changeAdminFlag("系统管理员")'>查看所有教师职称</a></td>    
  </tr>
</table>
<br />
  <center>
  ...
  <tr bgcolor="#FFFFFF" onmouseover="this.bgColor='f1f1f1'" onmouseout="this.bgColor='FFFFFF'">
    ...
    <td><%=rsobj("zc_id")%></td>
    <td><%=rsobj("zc_name")%></td>
    <td><a href='zc_add1.asp?Result=Modify&amp;ID=<%=rsobj("ID")%>' onClick='changeAdminFlag("修改教师职称")'><font color='#330099'>修改</font></a></td>
...
　
  <%
			if page <> 1 then
			response.Write"<a href=zc_table1.asp?txtpage=1>　第一页　</a>"
			response.Write"<a href=zc_table1.asp?txtpage="& (page-1)&">　上一页　</a>"
			end if 
			if page<>rsobj.pagecount then
			response.Write"<a href=zc_table1.asp?txtpage="& (page+1)&">　下一页　</a>"
			response.Write"<a href=zc_table1.asp?txtpage="& rsobj.pagecount&">　最末页　</a>"
			end if
			'关闭链接
			rsobj.close
			set rsobj=nothing
