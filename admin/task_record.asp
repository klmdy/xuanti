...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
	...
	<%
		...
		'sql="select * from sel_record where st_number='"&request("ID")&"'"
		sql="Select * from sel_record sr,select_cursor sc,student_info si where sr.st_number=si.st_number and sr.sel_id=sc.sel_id and sr.st_number='"&request("ID")&"'"
...
<br />
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
    <tr>
      <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>学号</strong></font></td>
      ...
      <td nowrap="nowrap" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>年级</strong></font></td>
      <td nowrap="nowrap" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>班级</strong></font></td>
      <td nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">指导老师成绩</font></strong></td>
      <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>评阅人成绩</strong></font></td>
      <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>答辩委员会成绩</strong></font></td>
      <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>等级</strong></font></td>
      <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>操作</strong></font></td>
    </tr>
  <%
		set rsobj=server.CreateObject("adodb.recordset")
		dim wh,xh
		...
		sql="Select * from sel_record sr,select_cursor sc,student_info si where sr.st_number=si.st_number and sr.sel_id=sc.sel_id "&wh&" order by sr.st_number asc"
		'response.Write(sql)
