...
<table width="167" height="26" border="0" cellpadding="0" cellspacing="0" background="../Images/SysLeft_bg_click.gif">
  <tr style="cursor: hand;">
    <td><a href="SysCome.asp"  onClick='changeAdminFlag("返回后台主页")'><img border="0" src="../Images/title.gif"></a></td>
  </tr>
</table>
...
<div id="sub3" style="display:none">
  <table width="160" border="0" cellspacing="0" cellpadding="0" background="../Images/SysLeft_bg_link.gif">
    <tr>
      ...
      <td class="SystemLeft"><a href="student_list.asp"  onClick='changeAdminFlag("审核学生")'>审核学生</a></td>
    </tr>
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="student_add.asp?Result=Add"  onClick='changeAdminFlag("添加学生")'>添加学生</a></td>
    </tr>
...
<div id="sub4" style="display:none">
  <table width="160" border="0" cellspacing="0" cellpadding="0" background="../Images/SysLeft_bg_link.gif">
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="task_list.asp"  onClick='changeAdminFlag("审核老师出的毕业论文题目")'>老师出题审核</a></td>
    </tr>
   
	   
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="task_yes.asp"  onClick='changeAdminFlag("查询学生选题信息")'>学生选题查询</a></td>
    </tr>   
...
<div id="sub12" style="display:none">
  <table width="160" border="0" cellspacing="0" cellpadding="0" background="../Images/SysLeft_bg_link.gif">
    ...
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="msg_list.asp"  onClick='changeAdminFlag("查看留言")'>查看过程化信息</a></td>
    </tr>
  </table>
</div>
...
<div id="sub9" style="display:none">
  <table width="160" border="0" cellspacing="0" cellpadding="0" background="../Images/SysLeft_bg_link.gif">
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="department_list.asp"  onClick='changeAdminFlag("查看系别")'>系别列表</a></td>
    </tr>
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="department_edit.asp?Result=Add"  onClick='changeAdminFlag("添加系别")'>添加系别</a></td>
    </tr>
  </table>
</div>
...
<div id="sub8" style="display:none">
  <table width="160" border="0" cellspacing="0" cellpadding="0" background="../Images/SysLeft_bg_link.gif">
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="speciality_List.asp"  onClick='changeAdminFlag("专业列表")'>专业列表</a></td>
    </tr>
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="speciality_add.asp?Result=Add"  onClick='changeAdminFlag("添加专业")'>添加专业</a></td>
    </tr>
  </table>
</div>
...
<div id="sub1" style="display:none">
  <table width="160" border="0" cellspacing="0" cellpadding="0" background="../Images/SysLeft_bg_link.gif">
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="user_list.asp"  onClick='changeAdminFlag("用户列表")'>管理员列表</a></td>
    </tr>
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="user_add.asp?Result=Add"  onClick='changeAdminFlag("添加用户")'>添加管理员</a></td>
    </tr>
  </table>
</div>
...
<div id="sub2" style="display:none">
  <table width="160" border="0" cellspacing="0" cellpadding="0" background="../Images/SysLeft_bg_link.gif">
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="teacher_list.asp"  onClick='changeAdminFlag("教师列表")'>查看所有</a></td>
    </tr>
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="teacher_add.asp?Result=Add"  onClick='changeAdminFlag("添加教师")'>添加教师</a></td>
    </tr>
...
<div id="sub6" style="display:none">
  <table width="160" border="0" cellspacing="0" cellpadding="0" background="../Images/SysLeft_bg_link.gif">
      <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="config.asp"  onClick='changeAdminFlag("网站信息")'>网站信息</a></td>
    </tr>
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="zc_table.asp"  onClick='changeAdminFlag("留言信息列表")'>教师职称</a></td>
    </tr>
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="res_table.asp"  onClick='changeAdminFlag("写新留言")'>教研室</a></td>
    </tr>
  </table>
</div>
...
<div id="sub11" style="display:none">
  ...
  <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="log.asp"  onClick='changeAdminFlag("查看日志")'>查看日志</a></td>
    </tr>
...
<table width="167" height="26" border="0" cellpadding="0" cellspacing="0" background="../Images/Admin_left_2.gif">
  <tr style="cursor: hand;">
    <td width="26"></td>
    <td class="SystemLeft"><a href="SysCome.asp"  onClick='changeAdminFlag("后台主页")'>后台主页</a></td>
  </tr>
</table>
...
<table width="167" border="0" cellpadding="1" cellspacing="2" bgcolor="#367BDA">
  <tr align="center" bgcolor="#367BDA">
    <td height=25 colspan=2 class="topbg"><span class="Glow"><font color="ffffff">毕业论文选题管理系统GMS（管理员）</font></span>
  <tr bgcolor="#EBF2F9">
