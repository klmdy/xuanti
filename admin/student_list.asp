...
<script language=JavaScript>
	...
	{
		if (confirm("确定审批通过吗？"))
		window.location = "student_add.asp?Action=shenpi&ID="+ID ;
	}
</script>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
	...
	<form action="student_list.asp" method="post">
...
&nbsp;
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
    <tr>
     <td nowrap bgcolor="#8DB5E9" align="center"><b><font color="#800000">批量审核</font></b></td>
      ...
      <td nowrap="nowrap" bgcolor="#8DB5E9" align="center" width="10%">
		<font color="#800000"><strong>姓名</strong></font></td>
      <td nowrap="nowrap" bgcolor="#8DB5E9" align="center" width="20%">
      ...
      <td nowrap bgcolor="#8DB5E9" align="center" width="10%">
		<font color="#800000"><strong>邮箱</strong></font></td>
 
      <td nowrap bgcolor="#8DB5E9" width="10%" align="center">
...
'		rsobj.open "select * from speciality",conn ,1,1
	...
	%>
	<form id="form1" name="form1" method="post" action="student_list.asp?Action=addnew">
...
<%
 ...
 %>
  ...
  <td width="137">
	<p align="center">
	<a href="student_add.asp?Action=del&stn=<%=rsobj("St_number")%>&ID=<%=rsobj("st.ID")%>;"  onclick="return confirm('是否确定将该生信息删除?提醒：一旦点击确定，该生所有信息将全部删除')"><font color='#FF0000'>删除</font></a> 
