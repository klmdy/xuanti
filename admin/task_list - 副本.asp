...
<br />
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
    <tr>
      ...
      <td nowrap="nowrap" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>选题方向</strong></font></td>
      <td nowrap="nowrap" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>选题难度</strong></font></td>
      <td nowrap="nowrap" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>指导老师</strong></font></td>
      <td nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">限选专业</font></strong></td>
      <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>有人选？</strong></font></td>
      <td nowrap="nowrap" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>详情</strong></font></td>
      <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>审核</strong></font></td>
      <td nowrap="nowrap" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>删除</strong></font></td>
    </tr>
  <%
  		wh = ""
  ...
  <tr bgcolor="#FFFFFF" onmouseover="this.bgColor='f1f1f1'" onmouseout="this.bgColor='FFFFFF'"  style='cursor:hand'  title="<%=rsobj("Sel_con")%>">
    ...
    <td><a href="task_excel.asp?sp=<%=rsobj("sel.sp_id")%>"><%=rsobj("Sp_name")%></a></td>
    <td>
    ...
    <td><a href="javascript:DoEmpty(<%=rsobj("Sel_id")%>);" onclick='changeAdminFlag(&quot;删除课题&quot;)'><font color='#330099'>删除</font></a></td>
    </tr>
  <%
	rsobj.movenext
	next
