...
Sub Main()
    ...
    Dim Folder
    Dim Num,FileCount
    UploadPath="../fileload/file/ybx/" &Result&"/" 
  ...
  <form name="form1" method="get" action="?path=">
    <tr> 
      <td height="20" sytle="line-height:150%">
		<p align="center"><b><font color="#000080">该生所有提交的毕业论文材料如下</font><font color="#FF0000"><br>
		（如果没有显示路径和文件名，则表明该生没有上传任何毕设材料！）</font></b></td>
    </tr>
     <tr> 
     <td >
	<p align="center">
	<%		address = request.ServerVariables("HTTP_REFERER")%>
			<input type="button" name="submitSaveEdit3" value="返回上一页" class="button" onclick="javascript:window.location.href='<%=address%>';" style="WIDTH: 84; float:center; height:20"> 
         </td>
        </tr>
  </form>
</table>
...
<table Width="100%" border="0" align=center cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <tr bgcolor="#8DB5E9"> 
    <td Width="6%" height=23 align="center"><font color="#800000"><strong>类型</strong></font></td>
    <td Width="51%" align="center"><font color="#800000"><strong>文件名</strong></font></td>
    <td Width="13%" align="center"><font color="#800000"><strong>文件大小</strong></font></td>
    <td Width="23%" align="center"><font color="#800000"><strong>上传日期</strong></font></td>
    <td Width="7%" align="center"><font color="#800000"><strong>操作</strong></font></td>
  </tr>
<%
...
%>
	...
	<p align="center">
	<%		address = request.ServerVariables("HTTP_REFERER")%>
			<input type="button" name="submitSaveEdit3" value="返回上一页" class="button" onclick="javascript:window.location.href='<%=address%>';" style="WIDTH: 77; float:center; height:21"> 
         </td>
        </tr>
</BODY>
</HTML>