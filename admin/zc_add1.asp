...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    <td height="24" align="center" nowrap  bgcolor="#EBF2F9"><a href="zc_add1.asp?Result=Add" onClick='changeAdminFlag("添加管理员")'>添加教师职称</a><font color="#0000FF">&nbsp;|&nbsp;</font><a href="zc_table1.asp" onClick='changeAdminFlag("系统管理员")'>查看所有教师职称</a></td>    
  </tr>
</table>
  <center>
    <br/>
	...
	%>
	<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <form name="editForm" method="post" action="zc_add1.asp?Action=addnew" onsubmit="return depart_add()">
  <tr>
    <td height="24" nowrap bgcolor="#EBF2F9"><table width="100%" border="0" cellpadding="0" cellspacing="0" id=editProduct idth="100%">
      ...
      <tr>
        <td height="20" align="right">教师职称编号：<br><br></td>
        <td><div align="left">
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <form name="editForm" method="post" action="zc_add1.asp?Action=SaveEdit&ID=<%=request("ID")%>" onsubmit="return depart_add()">
  <tr>
  <tr>
    <td height="24" nowrap bgcolor="#EBF2F9"><table width="100%" border="0" cellpadding="0" cellspacing="0" id="editProduct" idth="100%">
      <tr>
      ...
      <tr>
        <td height="30" align="right">　</td>
        <td valign="bottom"><div align="left">
        <input type="button" class="button" onClick="javascript :history.back(-1);" value=" 返 回 " style="WIDTH: 60; margin-left: 25px; ">
        </div></td>
        </tr>
...
'Action=addnew
	if Action = "SaveEdit" then
		...
		response.Redirect("zc_table1.asp")
	end if
