...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
	...
	<form id="form1" name="form1" method="post" action="task_list1.asp" style="line-height: 23px; ">
        <p>请选择年级：<select name="Sel_cour" id="Sel_cour">
...
　<br>关键字：
	...
	　<a href="task_list1.asp" onclick='changeAdminFlag(&quot;系统课题&quot;)'>查看所有选题</a> |&nbsp;</font><a href="task_excel.asp" onclick='changeAdminFlag(&quot;导出所有课题信息&quot;)'>导出选题信息(Excel表)</a>
	            </p>
	</form>	
    </td>    
  </tr>
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
    <tr>
      ...
      <td bgcolor="#8DB5E9" align="center"><strong>
		<font color="#800000">针对年级</font></strong></td>
      <td bgcolor="#8DB5E9" align="center">
		<font color="#800000"><strong>选题难度</strong></font></td>
      <td bgcolor="#8DB5E9" align="center">
		<font color="#800000"><strong>指导老师</strong></font></td>     
      <td bgcolor="#8DB5E9" align="center">
		<strong><font color="#800000">总共可选人数</strong></font></td>
		<td bgcolor="#8DB5E9"  align="center">
		<strong><font color="#800000">目前已选人数</strong></font></td>
      <td bgcolor="#8DB5E9" align="center">
		<font color="#800000"><strong>选题内容</strong></font></td>
      <td bgcolor="#8DB5E9" width="120" align="center">
		<font color="#800000"><strong>审核</strong></font></td>
  ...
  <tr bgcolor="#FFFFFF" onmouseover="this.bgColor='f1f1f1'" onmouseout="this.bgColor='FFFFFF'"  style='cursor:hand'  title="<%=rsobj("Sel_con")%>">
	...
	onClick='changeAdminFlag("审核课题")'><font color='#330099'>请审核</font></a>
	<%else%>
	已审核通过	
	<a href="?Result=nocheck&ID=<%=rsobj("Sel_id")%>&txtpage=<%=page%>"	 onclick="return confirm('真的确定撤销已经审核通过的该课堂吗?')"><font color='#FF0000'>可撤销</font></a>
