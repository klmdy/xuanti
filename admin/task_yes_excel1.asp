...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr align="center">
    <td colspan="4"><span style="font-weight: bold; color: #000066; font-size: large; font-family: &quot;楷体_GB2312&quot;;">已确选学生选题信息</span></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<%
	...
	sql = "select * from select_true selt,select_cursor sel,teacher_inf tea,student_info stu,speciality spe where selt.Tea_id=tea.Tea_id and  selt.St_number=stu.St_number and selt.sel_flag=True and selt.sel_id=sel.sel_id and spe.Sp_id = stu.Sp_id order by tea.Tea_id asc"
...
<br>
<span style="font-weight: bold; color: #000066; font-size: large; font-family: &quot;楷体_GB2312&quot;;">共计：<%=all-1%></span>
</body>
</html>