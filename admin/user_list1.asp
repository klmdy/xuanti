...
<script language=JavaScript>
	function DoEmpty(ID)
	{
		...
		window.location = "user_add1.asp?Action=del&ID="+ID ;
	}
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    <td height="24"  nowrap align="left" bgcolor="#EBF2F9">
	...
	<br><center><a href="user_list1.asp" onclick='changeAdminFlag(&quot;系统管理员&quot;)'>查看所有管理员</a></center>
...
'		rsobj.open "select * from speciality",conn ,1,1
  ...
  <tr bgcolor="#FFFFFF" onmouseover="this.bgColor='f1f1f1'" onmouseout="this.bgColor='FFFFFF'">
    ...
    <td><a href='user_add1.asp?Result=Modify&ID=<%=rsobj("u.ID")%>' onClick='changeAdminFlag("修改管理员")'><font color='#330099'>修改</font></a></td>
...
　
  <%
			if page <> 1 then
			response.Write"<a href=user_list1.asp?txtpage=1>　第一页　</a>"
			response.Write"<a href=user_list1.asp?txtpage="& (page-1)&">　上一页　</a>"
			end if 
			if page<>rsobj.pagecount then
			response.Write"<a href=user_list1.asp?txtpage="& (page+1)&">　下一页　</a>"
			response.Write"<a href=user_list1.asp?txtpage="& rsobj.pagecount&">　最末页　</a>"
			end if
			'关闭链接
			rsobj.close
			set rsobj=nothing
