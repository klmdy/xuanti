...
function exctoacc(excpath,sheet)
  ...
  sql="select * from [teacher_inf]"  '查询Access表
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <tr>
    <td height="24" nowrap="nowrap"><font color="#FFFFFF"><img src="../Images/Explain.gif" width="18" height="18" border="0" align="absmiddle" />&nbsp;<strong>教师管理：批量导入教师信息</strong></font></td>
  </tr>
  <tr>
    <td height="24" align="center" nowrap="nowrap"  bgcolor="#EBF2F9">
	<a href="teacher_list.asp" onclick='changeAdminFlag(&quot;系统学生&quot;)'>查看教师列表</a>
    | <a href="teacher_add.asp?Result=Add" onclick='changeAdminFlag(&quot;添加学生&quot;)'>单个添加教师</a>
	|&nbsp;</font><a href="teacher_excel.asp" onclick='changeAdminFlag(&quot;导出所有教师信息&quot;)'>导出教师信息</a>
	</td>
  </tr>
</table>
...
<p>注意：
  <br />
　　一、
准备正确的Excel数据表。（<a target="_blank" href="upload/教师信息表.xls"><font color="#FF0000">标准教师信息表下载</font></a>）<br />
　　
二、浏览并上传到服务器进行预处理。<br />　　
