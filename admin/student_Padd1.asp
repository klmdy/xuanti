...
function exctoacc(excpath,sheet)
  ...
  sql="select * from [student_info]"  '查询Access表
...
response.write "location.href='student_Padd1.asp';"
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <tr>
    <td height="24" nowrap="nowrap"><font color="#FFFFFF"><img src="../Images/Explain.gif" width="18" height="18" border="0" align="absmiddle" />&nbsp;<strong>学生管理：批量导入学生信息</strong></font></td>
  </tr>
  <tr>
    <td height="24" align="center" nowrap="nowrap"  bgcolor="#EBF2F9">
	<a href="student_list1.asp" onclick='changeAdminFlag(&quot;系统学生&quot;)'>查看所有学生</a>
    | <a href="student_add1.asp?Result=Add" onclick='changeAdminFlag(&quot;添加学生&quot;)'>单个添加学生</a>
...
<form action="?action=daoru" method="post" name="daoruf" id="daoruf" onSubmit="return check();">
 <div align="left">
  <table width="100%" height="126" border="1" align="center" cellpadding="2" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#D5EBF4">
    <tr> 
      <td height="21" colspan="2" align="center">【<strong>从Excel表导入学生信息到数据库</strong>】</td>
    </tr>
    <tr> 
...
<p>注意：
  <br />
　　一、
准备正确的Excel数据表。（<a target="_blank" href="upload/学生信息表.xls"><font color="#FF0000">标准学生信息表下载</font></a>）<br />　　
二、浏览并上传到服务器进行预处理。<br />　　
三、指定数据表名（Excel表的Sheet名，默认为Sheet1 ，如有不同务必修改）<br />
　　四、密码字段默认请用 admin 代替</p>
