...
<script language=JavaScript>
	function DoEmpty(ID)
	{
		...
		window.location = "department_edit1.asp?Action=del&ID="+ID ;
	}
</script>
<body>
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    <td height="24" align="center" nowrap  bgcolor="#EBF2F9"><a href="department_edit1.asp?Result=Add" onClick='changeAdminFlag("添加管理员")'>添加系别</a><font color="#0000FF">&nbsp;|&nbsp;</font><a href="department_list1.asp" onClick='changeAdminFlag("系统管理员")'>查看所有系别</a></td>    
  </tr>
</table>
<br />
  <center>
  <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
    <tr>
      <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>系别编号</strong></font></td>
      <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>系别名称</strong></font></td>
      <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>系院负责人</strong></font></td>
      <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>负责人电话</strong></font></td>
  ...
  <tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='f1f1f1'" onMouseOut="this.bgColor='FFFFFF'">
    ...
    <td><a href='department_edit1.asp?Result=Modify&ID=<%=rsobj("ID")%>' onClick='changeAdminFlag("修改系别")'><font color='#330099'>修改</font></a></td>
...
　
  <%
			if page <> 1 then
			response.Write"<a href=department_list1.asp?txtpage=1>　第一页　</a>"
			response.Write"<a href=department_list1.asp?txtpage="& (page-1)&">　上一页　</a>"
			end if 
			if page<>rsobj.pagecount then
			response.Write"<a href=department_list1.asp?txtpage="& (page+1)&">　下一页　</a>"
			response.Write"<a href=department_list1.asp?txtpage="& rsobj.pagecount&">　最末页　</a>"
			end if
			'关闭链接
			rsobj.close
			set rsobj=nothing
