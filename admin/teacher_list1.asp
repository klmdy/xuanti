...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
	...
	<br><a href="teacher_add1.asp?Result=Add" onclick='changeAdminFlag(&quot;添加管理员&quot;)'>添加教师</a>
	...
	<br><a href="teacher_list1.asp" onclick='changeAdminFlag(&quot;查看教师列表&quot;)'>查看所有教师</a>
	</form>
...
'		rsobj.open "select * from speciality",conn ,1,1
  ...
  <tr bgcolor="#FFFFFF" onmouseover="this.bgColor='f1f1f1'" onmouseout="this.bgColor='FFFFFF'">
    ...
    <td><a href='teacher_add1.asp?Result=Modify&ID=<%=rsobj("Tea_id")%>' onClick='changeAdminFlag("修改教师")'><font color='#330099'>修改</font></a></td>
    <td><a href="teacher_add1.asp?Action=del&ID=<%=rsobj("Tea_id")%>" onClick='changeAdminFlag("删除教师")'><font color='#330099'>删除</font></a></td>
  </tr>
  <%
	rsobj.movenext
	next
