...
<script language=JavaScript>
	function DoEmpty(ID)
	{
		...
		window.location = "res_add1.asp?Action=del&ID="+ID ;
	}
</script>
<body>
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    <td height="24" align="center" nowrap  bgcolor="#EBF2F9"><a href="res_add1.asp?Result=Add">添加教研室</a><font color="#0000FF">&nbsp;|&nbsp;</font><a href="res_table1.asp" onClick='changeAdminFlag("系统管理员")'>查看所有教研室</a></td>    
  </tr>
</table>
<br />
  <center>
  <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
    <tr>
      ...
      <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>教研室编号</strong></font></td>
      <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>所属系别</strong></font></td>
      <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>教研室名称</strong></font></td>
  ...
  <tr bgcolor="#FFFFFF" onmouseover="this.bgColor='f1f1f1'" onmouseout="this.bgColor='FFFFFF'">
    ...
    <td><a href='res_add1.asp?Result=Modify&amp;ID=<%=rsobj("res.ID")%>' onClick='changeAdminFlag("修改教研室")'><font color='#330099'>修改</font></a></td>
...
　
  <%
			if page <> 1 then
			response.Write"<a href=res_table1.asp?txtpage=1>　第一页　</a>"
			response.Write"<a href=res_table1.asp?txtpage="& (page-1)&">　上一页　</a>"
			end if 
			if page<>rsobj.pagecount then
			response.Write"<a href=res_table1.asp?txtpage="& (page+1)&">　下一页　</a>"
			response.Write"<a href=res_table1.asp?txtpage="& rsobj.pagecount&">　最末页　</a>"
			end if
			'关闭链接
			rsobj.close
			set rsobj=nothing
