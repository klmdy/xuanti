...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    <td height="24" align="center" nowrap  bgcolor="#EBF2F9" style="line-height: 23px; "><a href="teacher_add.asp?Result=Add" onClick='changeAdminFlag("添加管理员")'>添加教师</a><font color="#0000FF">|</font><a href="teacher_Padd1.asp" onclick='changeAdminFlag(&quot;批量导入教师信息&quot;)'>批量导入教师信息</a>
  |</font><a href="teacher_excel.asp" onclick='changeAdminFlag(&quot;导出所有教师信息&quot;)'>导出教师信息（Excel表）</a>
  <br><a href="teacher_list1.asp" onClick='changeAdminFlag("系统管理员")'>查看所有教师</a><font color="#0000FF">
	</td>    
  </tr>
</table>
  <center>
  ...
  <tr>
    <td height="24" nowrap bgcolor="#EBF2F9"><table width="100%" border="0" cellpadding="0" cellspacing="0" id=editProduct idth="100%">
      ...
      <tr>
        <td height="20" align="right">教师编号：<br><br></td>
        <td><div align="left">
