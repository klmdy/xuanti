...
<div id="sub2" style="display:none">
  <table width="160" border="0" cellspacing="0" cellpadding="0" background="../Images/SysLeft_bg_link.gif">
    ...
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="teacher_Padd.asp" target="mainFrame" onClick='changeAdminFlag("批量导入教师信息")'>批量导入</a></td>
    </tr>
	    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="teacher_excel.asp" target="mainFrame" onClick='changeAdminFlag("导出所有教师信息")'>导出所有</a></td>
    </tr>
  </table>
</div>
...
<div id="sub3" style="display:none">
  <table width="160" border="0" cellspacing="0" cellpadding="0" background="../Images/SysLeft_bg_link.gif">
    ...
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="student_Padd.asp" target="mainFrame" onClick='changeAdminFlag("批量导入学生")'>批量导入</a></td>
    </tr>
	  <tr>
      <td width="36" height="22"></td>
  ...
  <table width="160" border="0" cellspacing="0" cellpadding="0" background="../Images/SysLeft_bg_link.gif">
    <tr>
      ...
      <td class="SystemLeft"><a href="task_list.asp" target="mainFrame" onClick='changeAdminFlag("课题列表")'>选题查询</a></td>
	    ...
	    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="task_padd.asp" target="mainFrame" onClick='changeAdminFlag("添加选题")'>批量导入选题</a></td>
    </tr>
    <tr>
      <td width="36" height="22"></td>
    ...
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="task_view.asp" target="mainFrame" onClick='changeAdminFlag("已选题学生")'>未确选情况</a></td>
    </tr>
    <tr>
      <td width="36" height="22"></td>
...
<div id="sub5" style="display:none">
  <table width="160" border="0" cellspacing="0" cellpadding="0" background="../Images/SysLeft_bg_link.gif">
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="task_record.asp" target="mainFrame" onClick='changeAdminFlag("留言信息列表")'>课题评分</a></td>
    </tr>
    <tr>
      <td width="36" height="22"></td>
      <td class="SystemLeft"><a href="record_excel.asp" target="mainFrame" onClick='changeAdminFlag("导出报表")'>导出报表</a></td>
    </tr>
  </table>
</div>
...
<table width="167" border="0" cellpadding="1" cellspacing="2" bgcolor="#367BDA">
  <tr align="center" bgcolor="#367BDA">
    <td height=25 colspan=2 class="topbg"><span class="Glow"><font color="ffffff">毕业论文选题系统（管理员）</font></span>
  <tr bgcolor="#EBF2F9">
