...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    <td height="24" align="center" nowrap  bgcolor="#EBF2F9"><a href="student_add1.asp?Result=Add" onClick='changeAdminFlag("添加学生")'>添加学生</a><font color="#0000FF">&nbsp;|&nbsp;</font><a href="student_list1.asp" onClick='changeAdminFlag("查看所有学生")'>查看所有学生</a>
	|&nbsp;</font><a href="student_Padd1.asp" onClick='changeAdminFlag("批量导入学生信息")'>批量导入学生信息</a>
  ...
  <option value="02">02班</option>
      ...
      <tr>
        <td height="20" align="right"><b><font color="#800000">手机号码：<br><br></font></b></td>
        <td><div align="left">
            <input name="St_m_phone" type="text" class="textfield" id="St_m_phone" style="WIDTH: 120;" size="19" />
          &nbsp;*<br>(请填写当前有效的联系方式)</div></td>
      </tr>
      <tr>
	...
	if Action = "addnew" then
		...
		rs.open sql1,conn,1,3
			if rs.bof and rs.eof then
				...
				rs.close
				set rs = nothing
				response.Redirect("student_list1.asp")
			else
