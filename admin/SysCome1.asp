...
&nbsp;&nbsp;&nbsp;&nbsp; （5）被评为校级优秀毕业论文的学生需准备两份毕业论文正稿（带封面）。<p align="left" style="line-height: 200%">&nbsp;   
	...
	<marquee behavior="alternate" width="100%" height="20">预祝各位同学毕业设计顺利完成并取得好成绩！　 </marquee></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </font>    
  
      <br>
      <input type="button" class="button" onclick="location.href='bnuzitc1.asp'" value=" 返 回 " style="WIDTH: 60; align:center;"> <br><br>  
    </td>                                                                                                                                                                                       
  </tr> 
