...
<center>
  <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
    <tr>
      ...
      <td nowrap="nowrap" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>用户编号</strong></font></td>
      <td nowrap="nowrap" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>操作类型</strong></font></td>
      ...
      <td nowrap="nowrap" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>用户名</strong></font></td>
    </tr>
			<%
