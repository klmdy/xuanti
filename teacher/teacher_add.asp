...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <tr>
    <td height="24"  ><font color="#FFFFFF"><img src="../Images/Explain.gif" width="18" height="18" border="0" align="absmiddle">&nbsp;<strong>教师管理：添加，修改教师信息</strong></font></td>
  </tr>
  <tr>
    <td height="24" align="center"   bgcolor="#EBF2F9"><font color="#0000FF">&nbsp;</font><a href="teacher_list.asp" onClick='changeAdminFlag("系统管理员")'>查看所有教师</a><font color="#0000FF">&nbsp;| </font></font><a href="teacher_excel.asp" onclick='changeAdminFlag(&quot;导出所有教师信息&quot;)'>导出所有教师信息（Excel表）</a></td>
  </tr>
</table>
  <center>
    <br/>
        ...
        <td height="24"   bgcolor="#EBF2F9"><table width="100%" border="0" cellpadding="0" cellspacing="0" id="editProduct" idth="100%">
            ...
            <tr>
              ...
              <td valign="bottom"><div align="left">
                  <input name="submitSaveEdit3" type="submit" class="button"  id="submitSaveEdit3" value=" 返回教师列表 " style="wdith: 60;">
