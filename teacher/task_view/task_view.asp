...
<br />
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
    <tr>
      <td width="6%" nowrap="nowrap" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>学号</strong></font></td>
      <td width="6%" nowrap="nowrap" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>姓名</strong></font></td>
      <td width="11%" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">选题名称</font></strong></td>
      <td width="30%" nowrap="nowrap" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>选题内容</strong></font></td>    
      <td width="8%" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">选题方向</font></strong></td>
      <td width="8%" nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>选题难度</strong></font></td>
      <td width="7%" nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>详情</strong></font></td>
      <td width="13%" nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>操作</strong></font></td>
    </tr>
  <%
  ...
  <tr bgcolor="#FFFFFF" onmouseover="this.bgColor='f1f1f1'" onmouseout="this.bgColor='FFFFFF'"  style='cursor:hand'  title="<%=rsobj("Sel_con")%>">
	...
	<a href="#" onClick="javascript:if(confirm('确选该学生？'))href='task_add.asp?Action=yes&scid=<%=rsobj("selt.St_number")%>&ID=<%=rsobj("sel.Sel_id")%>&txtpage=<%=page%>'"><font color='#330099'>确选该学生</font></a>
	<%else%>
	
	<a href="#" onClick="javascript:if(confirm('确定取消确选该学生？'))href='task_add.asp?Action=del&scid=<%=rsobj("selt.St_number")%>&ID=<%=rsobj("sel.Sel_id")%>&txtpage=<%=page%>'"><font color='#FF0000'>取消确选(已确选)</font></a>
