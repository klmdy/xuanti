...
<br />
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
    <tr>
      <td width="4%" nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>ID</strong></font></td>
      <td width="41%" nowrap="nowrap" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>选题名称</strong></font></td>
      <td width="9%" nowrap="nowrap" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>选题方向</strong></font></td>
      <td width="8%" nowrap="nowrap" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>选题难度</strong></font></td>
      <td width="8%" nowrap="nowrap" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>指导老师</strong></font></td>
      <td width="6%" nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">限选人数</font></strong></td>
      <td width="8%" nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>有人选？</strong></font></td>
      <td width="8%" nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>详情</strong></font></td>
      <td width="8%" nowrap="nowrap" bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>审核</strong></font></td>
    </tr>
  <%
  		wh = ""
		...
		sql = "select * from select_cursor sel,teacher_inf tea where sel.Tea_id=tea.Tea_id"&wh&" order by Sel_id asc"
...
'		rsobj.open "select * from speciality",conn ,1,1
  ...
  <tr bgcolor="#FFFFFF" onmouseover="this.bgColor='f1f1f1'" onmouseout="this.bgColor='FFFFFF'"  style='cursor:hand'  title="<%=rsobj("Sel_con")%>">
	...
	<% end if%>
    <td><a href="task_add.asp?Result=Modify&ID=<%=rsobj("Sel_id")%>&txtpage=<%=page%>"
