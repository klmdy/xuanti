...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  <tr>
    <td height="24" nowrap><font color="#FFFFFF"><img src="../Images/Explain.gif" width="18" height="18" border="0" align="absmiddle">&nbsp;<strong>学生选题情况：查看所有选择我课题的学生名单</strong></font></td>
  </tr>
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
    <tr>
      <td width="7%" nowrap="nowrap" bgcolor="#8DB5E9" align="center">
		<font color="#800000"><strong>学号</strong></font></td>
      <td width="5%" nowrap="nowrap" bgcolor="#8DB5E9" align="center">
		<font color="#800000"><strong>姓名</strong></font></td>
      <td width="20%" nowrap bgcolor="#8DB5E9" align="center">
		<font color="#800000"><strong>选题名称</strong></font></td>
       
      <td width="5%" nowrap bgcolor="#8DB5E9" align="center">
		<font color="#800000"><strong>选题方向</strong></font></td>
      <td width="4%" nowrap bgcolor="#8DB5E9" align="center">
		<font color="#800000"><strong>选题难度</strong></font></td>
      <td width="10%" nowrap bgcolor="#8DB5E9" align="center">
		<font color="#800000"><strong>详情</strong></font></td>
      <td width="30%" nowrap bgcolor="#8DB5E9" align="center">
  ...
  <tr bgcolor="#FFFFFF" onmouseover="this.bgColor='f1f1f1'" onmouseout="this.bgColor='FFFFFF'"  style='cursor:hand'  title="<%=rsobj("Sel_con")%>">
    ...
    <td width="10%">
	<p align="center"><a href="task_add.asp?Result=Modify&ID=<%=rsobj("sel.Sel_id")%>&txtpage=<%=page%>"	onClick='changeAdminFlag("查看详情")'><font color='#330099'>查看该选题详情</font></a></td>
    <td width="30%" >
	<%if rsobj("selt.Sel_flag")=false then%>
	<a href="#" onClick="javascript:if(confirm('确选该学生选择此课题吗？'))href='task_add.asp?Action=yes&scid=<%=rsobj("selt.St_number")%>&ID=<%=rsobj("sel.Sel_id")%>&txtpage=<%=page%>'"><font color='#330099'>确选</font></a>|
	<a href="#" onClick="javascript:if(confirm('确定取消该学生选择此课题吗？'))href='task_add.asp?Action=del&scid=<%=rsobj("selt.St_number")%>&ID=<%=rsobj("sel.Sel_id")%>&txtpage=<%=page%>'"><font color='#330099'>取消</font></a>
	<%else%>	
	</font>
	该生已经确选!如需取消请<b><a href="#" onClick="javascript:if(confirm('确定取消该学生的这个选题吗？'))href='task_add.asp?Action=del&scid=<%=rsobj("selt.St_number")%>&ID=<%=rsobj("sel.Sel_id")%>&txtpage=<%=page%>'"><font color='#FF0000'><u>点击此处</u></font></a></b>	
	<%end if%>
	</td>
  </tr>
  <%
