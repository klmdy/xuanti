...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
  ...
  <tr>
    ...
    <td height="24" align="center" nowrap  bgcolor="#EBF2F9"><a href="student_add1.asp?Result=Add" onClick='changeAdminFlag("添加学生")'>添加学生</a><font color="#0000FF">&nbsp;|&nbsp;</font><a href="student_list.asp" onClick='changeAdminFlag("查看所有学生")'>查看所有学生</a>
  ...
  <form name="editForm" method="post" action="student_add1.asp?Action=addnew" onsubmit="return depart_add()">
    ...
    <td height="24" nowrap bgcolor="#EBF2F9"><table width="100%" border="0" cellpadding="0" cellspacing="0" id=editProduct idth="100%">
      ...
      <tr>
              ...
              <td><div align="left">
                  ...
                  <input name="Tea_pass" type="password" class="textfield" id="Tea_pass" style="WIDTH: 120;" size="19" />
            ...
            <tr>
              ...
              <td><div align="left">
                  ...
                  <input name="Tea_pass1" type="password" class="textfield" id="Tea_pass1" style="WIDTH: 120;" size="19" />
      ...
      <tr>
        ...
        <td><div align="left">
            ...
            <input name="St_origin" type="text" class="textfield" id="St_origin" style="WIDTH: 120;" size="19" />
