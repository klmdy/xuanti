...
<br />
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
    ...
    <tr>
      ...
      <td nowrap bgcolor="#8DB5E9"><strong><font color="#FFFFFF">限选人数</font></strong></td>

      <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>&nbsp;是否已选？</strong></font></td>

      <td nowrap="nowrap" bgcolor="#8DB5E9"><strong><font color="#FFFFFF">开始选题</font></strong></td>
  ...
  <tr bgcolor="#FFFFFF" onmouseover="this.bgColor='f1f1f1'" onmouseout="this.bgColor='FFFFFF'"  style='cursor:hand'  title="<%=rsobj("Sel_con")%>">
	...
	<% if rsobj("sel_flag") < rsobj("Sel_nu")  then%>

	目前有<%=rsobj("sel_flag")%>人选！
   ...
   <a href='task_add.asp?Result=Modify&ID=<%=rsobj("Sel_id")%>&teachername=<%=rsobj("Tea_name")%>' onClick='changeAdminFlag("开始选题")'><b><font color="#0000FF">
	...
	<font color="#FF0000"><b>课题申请已经成功审批！</b></font>
	...
	<font color="#FF0000"><b>该课题已经选满</b></font>
