...
<br />
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#6298E1">
    <tr>
      ...
      <td nowrap bgcolor="#8DB5E9"><font color="#FFFFFF"><strong>已确选？</strong></font></td>
  ...
  <%
		...
		sql = "select * from select_cursor sel,teacher_inf tea where sel.Tea_id=tea.Tea_id and sel_flag=false "&wh&" order by Sel_id asc"
...
'		rsobj.open "select * from speciality",conn ,1,1
  ...
  <tr bgcolor="#FFFFFF" onmouseover="this.bgColor='f1f1f1'" onmouseout="this.bgColor='FFFFFF'"  style='cursor:hand'  title="<%=rsobj("Sel_con")%>">
	...
	%>
	<a href="javascript:DoEmpty(<%=rsobj("Sel_id")%>);" onClick='changeAdminFlag("选择该课题")'>
