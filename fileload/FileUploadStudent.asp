...
<%  
   ...
   if  Session("studentselect") = false  then %>
    ...
    <thead>
      <tr>
        <td colspan="2">
		<p align="center"><b><font color="#FF0000">你还没有选题或者你的选题还没有得到老师的批准，因此无法上传文档。</font></b></td>
      </tr>
    </thead>
    </table>
...
<form id="uploadForm" action="filestudent.asp?ID=<%=Session("studentnumber")%>" method="post"   enctype="multipart/form-data">
  <table width="67%" border="0" align="center" cellspacing="1" class="fu_list">
    <thead>
      <tr>
        <td colspan="2">
		<p align="center"><b><font color="#0000FF">学生上传开题报告和毕业论文<br>
		</font><font color="#FF0000">（</b>请注意WORD文档中的图片最好压缩成JPG格式，然后再通过WORD菜单命令中的<br>
&nbsp; &quot;<b>插入-插入图片-文件导入</b>&quot;<br>
		到指定地方，这样可以减少文件容量。<b>）</b></font></td>
      </tr>
    </thead>
    <tbody>
      <tr>
      ...
      <tr>
        <td colspan="2" style="color:gray"><font color="#FF0000">温馨提示：请只上传自己的开题报告和毕业论文的WORD文档，不要上传其他无关文档。 </font> </td>
      </tr>
      <tr>
...
<p class="STYLE1">　　·开题报告命名格式：学号_姓名_开题报告.doc</p>
<p class="STYLE1">　　·毕业论文命名格式：学号_姓名_毕业论文.doc</p>
