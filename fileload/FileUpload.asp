...
<form id="uploadForm" action="file.asp" method="post"   enctype="multipart/form-data">
  <table width="67%" border="0" align="center" cellspacing="1" class="fu_list">
    ...
    <tbody>
      ...
      <tr>
        <td colspan="2" style="color:gray">温馨提示：最多可同时上传 <b id="idLimit"></b> 个文件，只允许上传 <b id="idExt"></b> 文件，请注意格式及文件名。 </td>
      </tr>
      <tr>
...
function Finish(msg){ alert(msg); location.href = location.href; }
  ...
  <span class="STYLE1">　<strong>　注意：</strong></span></p>
<p class="STYLE1">　　·请选择【<strong id="idExt">rar，doc，xls</strong>】格式的文件，其他格式的文件请打包后再上传。</p>
<p class="STYLE1">　　·文件名尽量详细，以方便下载。</p>
<p class="STYLE1"> 　　·文件不能过大。 </p>
</body>
</html>
